...
public class Innerfundtrans extends InnerfundtransKey {
    ...
    private String origfundtransnbr;
    ...
    public String getOrigfundtransnbr() {
        return origfundtransnbr;
    }

    public void setOrigfundtransnbr(String origfundtransnbr) {
        this.origfundtransnbr = origfundtransnbr;
    }
